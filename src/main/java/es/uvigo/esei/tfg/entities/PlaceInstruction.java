...
public class PlaceInstruction {
	...
	public String toString() {
		return "PlaceInstruction [orderType=" + orderType + ", selectionId=" + selectionId + ", handicap=" + handicap
				+ ", side=" + side + ", limitOrder=" + limitOrder + ", limitOnCloseOrder=" + limitOnCloseOrder
