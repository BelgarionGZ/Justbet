...
public class MarketDescription {
	...
	public String toString() {
		return "{" + "" + "persistenceEnabled=" + getPersistenceEnabled() + "," + "bspMarket=" + getBspMarket() + ","
				+ "marketTime=" + getMarketTime() + "," + "suspendTime=" + getSuspendTime() + "," + "settleTime="
				+ getSettleTime() + "," + "bettingType=" + getBettingType() + "," + "turnInPlayEnabled="
				+ getTurnInPlayEnabled() + "," + "marketType=" + getMarketType() + "," + "regulator=" + getRegulator()
				+ "," + "marketBaseRate=" + getMarketBaseRate() + "," + "discountAllowed=" + getDiscountAllowed() + ","
