...
public class MarketBook {
	...
	public String toString() {
		return "{" + "" + "marketId=" + getMarketId() + "," + "isMarketDataDelayed=" + getIsMarketDataDelayed() + ","
				+ "status=" + getStatus() + "," + "betDelay=" + getBetDelay() + "," + "bspReconciled="
				+ getBspReconciled() + "," + "complete=" + getComplete() + "," + "inplay=" + getInplay() + ","
				+ "numberOfWinners=" + getNumberOfWinners() + "," + "numberOfRunners=" + getNumberOfRunners() + ","
				+ "numberOfActiveRunners=" + getNumberOfActiveRunners() + "," + "lastMatchTime=" + getLastMatchTime()
				+ "," + "totalMatched=" + getTotalMatched() + "," + "totalAvailable=" + getTotalAvailable() + ","
				+ "crossMatching=" + getCrossMatching() + "," + "runnersVoidable=" + getRunnersVoidable() + ","
				+ "version=" + getVersion() + "," + "runners=" + getRunners() + "," + "}";
	}
}